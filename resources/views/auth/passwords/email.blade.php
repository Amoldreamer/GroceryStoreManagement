                    ...
                    <div class="flex-center position-ref full-height" >
                            @if (Route::has('login'))
                                <div class="top-right links" >
                                    @auth
                                        <a href="{{ url('/home') }}" style="text-decoration: none; color:white;">Home</a>
                                    @else
            ...
            <div class="container-fluid" style="margin-top:20vh;">
                <div class="row ">
                    <div class="col-md-4 col-sm-6 col-md-offset-4" style="border-radius:6%;" >
                                <form method="POST" action="{{ route('password.email') }}" style="padding:5%;border-radius:6px;">
                                    {{csrf_field()}}
                                    <label for="uname"><b>{{ __('Reset Password') }}</b></label>
