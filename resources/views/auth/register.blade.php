...
<div class="signup-form">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            {{-- <input id="name" type="email" class="form-control" name="email" placeholder="Email" required="required"> --}}
	...
	<div class="text-center">Already have an account? <a href="{{ route('login') }}">Log in</a></div>
</div>
</body>
</html>                            